...
const inlineTypes = new Set(["pdf", "image", "text"]);
...
export async function GET(
  ...
  const disposition = inlineTypes.has(doc.type) ? "inline" : "attachment";
  const ext = doc.type === "pdf" ? ".pdf" : doc.type === "docx" ? ".docx" : doc.type === "xlsx" ? ".xlsx" : doc.type === "pptx" ? ".pptx" : doc.type === "image" ? ".jpg" : ".txt";
